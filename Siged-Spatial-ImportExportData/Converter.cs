...
namespace Siged_Spatial_ImportExportData
{
    ...
    /* Ellipsoid model constants (actual values here are for NAD27) */
    //public static double sm_a = 6378206.4;
    //public static double sm_b = 6356583.8;

    //public static double sm_EccSquared = 6.768658e-03;
    //public static double UTMScaleFactor = 0.9996;
        ...
        public static double[] MapXYToLatLon(double x, double y, double lambda0)
        {
        ...
        public static double[] UTMXYToLatLon(double x, double y, int zone, Boolean southhemi)
        {
            ...
            puntos = MapXYToLatLon(x, y, cmeridian);
            return puntos;
        }
